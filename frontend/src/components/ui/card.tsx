...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-primary-100/60 bg-white/95 backdrop-blur-sm text-neutral-900 shadow-soft hover:shadow-gentle transition-all duration-300 hover:border-primary-200/80 hover:-translate-y-0.5",
      className
    )}
    {...props}
  />
